...
int16_t spsa_in_biases[L1SIZE] = {
  19, 92,  84, 51, 77, 3,   -14, 48, 102, -28, -55, 47,  71,  53,  16, -34,
  -4, 115, 41, 4,  74, 39,  102, -6, 127, 67,  -16, 9,   72,  122, 77, 68,
  -4, 2,   45, 42, 40, 7,   122, 15, 5,   87,  -7,  125, -25, 29,  22, -8,
  49, 52,  49, 5,  41, -33, 5,   -2, 26,  -51, 98,  23,  26,  97,  2,  78,
};

int16_t spsa_l1_weights_3_bucket[L1SIZE * 2] = {
  -46, -78, 40,  -47, -43, 75,  -57, -36, -57, -71, -34, -57, 59,  -66, -51, -75, 70,  65,  2,
  -58, -43, 59,  33,  -57, -36, 43,  -74, 74,  52,  -59, 64,  -62, -55, -63, -52, -20, 63,  -47,
  -56, -68, -43, 49,  48,  3,   -58, -55, -19, 86,  45,  -47, 58,  -67, 72,  71,  16,  -71, 41,
  72,  74,  58,  -14, -32, 27,  -62, 50,  77,  -41, 48,  45,  -80, 68,  34,  57,  91,  40,  57,
  -65, 53,  56,  83,  -61, -75, -2,  58,  43,  -62, -33, 74,  43,  -42, 89,  -75, -55, 57,  -68,
  61,  59,  64,  56,  17,  -64, 45,  61,  67,  42,  -51, -50, 0,   59,  58,  14,  -89, -45, 48,
  -57, 73,  -73, -72, -12, 77,  -46, -78, -83, -59, 14,  33,  -24, 60,
};
...
SMALL void nnue_init() {
    ...
    for (int i = 0; i < L1SIZE; i++)
        in_biases[i] = spsa_in_biases[i];

    for (int i = 0; i < L1SIZE * 2; i++)
        l1_weights[3][i] = spsa_l1_weights_3_bucket[i];
}
