...
static void init_bmi2(uint16_t  table[],
                      uint16_t* attacks[],
                      Bitboard  masks[],
                      Bitboard  masks2[],
                      int       deltas[],
...
static void init_sliding_attacks(void) {
    init_bmi2(RookTable, RookAttacks, RookMasks, RookMasks2, RookDirs, bmi2_index_rook);
    init_bmi2(BishopTable, BishopAttacks, BishopMasks, BishopMasks2, BishopDirs, bmi2_index_bishop);
}
