...
PARAM(ttct_v2, 130, 12.0)
PARAM(qmo_v1, 440, 38.0)
PARAM(qmo_v2, 1256, 120.0)
PARAM(qmo_v3, 895, 120.0)
PARAM(rz_v1, 6, 0.5)
PARAM(rz_v2, 354, 16.0)
PARAM(rz_v3, 244, 10.0)
PARAM(ft_v1, 87, 12.0)
PARAM(ft_v2, 16, 0.5)
PARAM(nmp_v5, 25287, 150.0)
PARAM(nmp_v6, 27, 3.0)
PARAM(nmp_v8, 91, 6.0)
PARAM(nmp_v9, 200, 12.0)
PARAM(rd_v1, 560, 60.0)
PARAM(rd_v2, 1238, 48.0)
PARAM(rd_v3, 878, 72.0)
PARAM(rd_init_v1, 3696, 150.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 5, 9.6)
PARAM(cbp_v3, -9, 9.6)
PARAM(cbp_v4, -13, 9.6)
PARAM(fpp_v1, 7, 0.5)
PARAM(fpp_v2, 216, 24.0)
PARAM(fpp_v3, 169, 21.6)
PARAM(fpp_v4, 68, 7.2)
PARAM(fpp_v5, 68, 7.2)
PARAM(sqsee_v1, 26, 2.4)
PARAM(scsee_v1, 206, 12.0)
PARAM(se_v2, 154, 15.0)
PARAM(se_v5, 28, 3.6)
PARAM(prb_v1, 122, 14.4)
PARAM(prb_v2, 48, 4.8)
PARAM(lmr_v3, 3782, 300.0)
PARAM(lmr_v8, 14491, 150.0)
PARAM(hb_v1, 915, 75.0)
PARAM(hb_v2, 204, 18.0)
PARAM(hb_v3, 153, 24.0)
PARAM(hb_v4, 2427, 180.0)
PARAM(hm_v1, 707, 75.0)
PARAM(hm_v2, 201, 18.0)
PARAM(hm_v3, 124, 24.0)
PARAM(hm_v4, 1824, 180.0)
PARAM(cnht_v1, 1036, 80.0)
PARAM(cnht_v2, 1028, 80.0)
PARAM(cnht_v3, 1011, 80.0)
PARAM(cnht_v4, 1011, 80.0)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 184, 18.0)
PARAM(ch_v1, 22, 3.6)
PARAM(ch_v2, 179, 18.0)
PARAM(ch_v3, 245, 24.0)
PARAM(ch_v4, 94, 12.0)
PARAM(ch_v5, 140, 12.0)
PARAM(ch_v6, 130, 12.0)
PARAM(ch_v7, 118, 12.0)
PARAM(ch_v8, 127, 12.0)
PARAM(tempo, 43, 4.8)
PARAM(mp_v3, 2609, 180.0)
PARAM(mp_v4, 186, 12.0)
PARAM(mp_v5, 323, 12.0)
PARAM(mp_v6, 290, 12.0)
PARAM(mp_v7, 248, 12.0)
PARAM(mp_v8, 130, 12.0)
PARAM(eval_scale, 91, 3.0)
PARAM(mat_scale, 25918, 420.0)
PARAM(mat_n, 648, 60.0)
PARAM(mat_b, 749, 78.0)
PARAM(mat_r, 1476, 120.0)
PARAM(mat_q, 2585, 240.0)
PARAM(pcmb_v1, 83, 12.0)
PARAM(pcmb_v3, 23, 4.8)
PARAM(pcmb_v4, 152, 12.0)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 107, 12.0)
PARAM(pcmb_v7, 95, 12.0)
PARAM(pcmb_v8, 129, 8.4)
PARAM(pcmb_v9, 247, 30.0)
PARAM(pcmb_v10, 127, 8.4)
PARAM(pcmb_v11, 142, 8.4)
PARAM(r_v2, 2411, 250.0)
PARAM(r_v6, 1216, 150.0)
PARAM(r_v7, 1102, 150.0)
PARAM(r_v8, 1332, 150.0)
PARAM(r_v9, 986, 150.0)
PARAM(r_v13, 1002, 50.0)
PARAM(ded_v1, 65, 7.2)
PARAM(qb_v1, 184, 18.0)
PARAM(qb_v2, 184, 18.0)
PARAM(cms_v1, 29126, 300.0)
PARAM(hu_v1, 10309, 300.0)
PARAM(cpth_v1, 11646, 300.0)
