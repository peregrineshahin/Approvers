...
// Search parameters
PARAM(ttct_v1, 104, 9.6)
PARAM(ttct_v2, 103, 9.6)
PARAM(qmo_v1, 371, 30.0)
PARAM(qmo_v2, 1283, 120.0)
PARAM(qmo_v3, 1024, 120.0)
PARAM(ft_v1, 184, 18.0)
PARAM(rd_v1, 596, 60.0)
PARAM(rd_v2, 1224, 48.0)
PARAM(rd_v3, 916, 72.0)
PARAM(rd_init_v1, 2953, 120.0)
PARAM(d_v1, 17, 1.2)
PARAM(cbp_v2, 2, 9.6)
PARAM(cbp_v3, -2, 9.6)
PARAM(cbp_v4, -5, 9.6)
...
PARAM(fpp_v4, 68, 7.2)
PARAM(fpp_v5, 66, 7.2)
PARAM(sqsee_v1, 28, 2.4)
PARAM(scsee_v1, 202, 12.0)
PARAM(se_v2, 112, 12.0)
PARAM(se_v5, 25, 3.6)
PARAM(prb_v1, 119, 14.4)
PARAM(prb_v2, 43, 4.8)
PARAM(rfp_v1, 9, 0.6)
PARAM(lmr_v3, 3819, 300.0)
PARAM(lmr_v4, 104, 12.0)
PARAM(lmr_v5, 94, 12.0)
PARAM(lmr_v6, 91, 12.0)
PARAM(lmr_v7, 114, 12.0)
PARAM(hb_v1, 694, 60.0)
PARAM(hb_v2, 201, 18.0)
PARAM(hb_v3, 142, 24.0)
PARAM(hb_v4, 2556, 180.0)
PARAM(hm_v1, 622, 60.0)
PARAM(hm_v2, 188, 18.0)
PARAM(hm_v3, 154, 24.0)
PARAM(hm_v4, 1729, 180.0)
PARAM(asd_v1, 4, 0.6)
PARAM(qsf_v1, 180, 18.0)
PARAM(ch_v1, 21, 3.6)
PARAM(ch_v2, 180, 18.0)
PARAM(ch_v3, 274, 24.0)
PARAM(ch_v4, 83, 9.6)
PARAM(ch_v5, 107, 9.6)
PARAM(ch_v6, 98, 9.6)
PARAM(ch_v7, 96, 9.6)
...
PARAM(mat_scale, 26335, 420.0)
PARAM(mat_n, 654, 60.0)
PARAM(mat_b, 767, 78.0)
PARAM(mat_r, 1372, 120.0)
PARAM(mat_q, 2531, 240.0)
PARAM(pcmb_v1, 93, 12.0)
PARAM(pcmb_v3, 25, 4.8)
PARAM(pcmb_v4, 161, 12.0)
PARAM(pcmb_v5, 7, 0.6)
...
PARAM(r_v2, 2380, 250.0)
PARAM(r_v6, 1294, 150.0)
PARAM(r_v7, 1120, 150.0)
PARAM(r_v8, 2234, 250.0)
PARAM(r_v9, 1747, 250.0)
PARAM(r_v10, 913, 100.0)
PARAM(r_v11, 945, 100.0)
PARAM(r_v12, 1020, 100.0)
PARAM(r_v13, 1002, 50.0)
PARAM(ded_v1, 66, 7.2)
PARAM(lce_v1, 2279, 18.0)
PARAM(qb_v1, 187, 18.0)
PARAM(qb_v2, 192, 18.0)
PARAM(cms_v1, 29255, 300.0)
PARAM(hu_v1, 10234, 300.0)
PARAM(cpth_v1, 11823, 300.0)
