...
// Search parameters
PARAM(ttct_v1, 113, 9.6)
PARAM(ttct_v2, 99, 9.6)
PARAM(qmo_v1, 379, 30.0)
PARAM(qmo_v2, 1368, 120.0)
PARAM(qmo_v3, 882, 120.0)
PARAM(ft_v1, 179, 18.0)
PARAM(rd_v1, 582, 60.0)
PARAM(rd_v2, 1237, 48.0)
PARAM(rd_v3, 832, 72.0)
PARAM(rd_init_v1, 2869, 120.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 6, 9.6)
PARAM(cbp_v3, -8, 9.6)
PARAM(cbp_v4, -16, 9.6)
PARAM(fpp_v1, 7, 0.6)
PARAM(fpp_v2, 217, 24.0)
PARAM(fpp_v3, 188, 21.6)
PARAM(fpp_v4, 66, 7.2)
PARAM(fpp_v5, 74, 7.2)
PARAM(sqsee_v1, 26, 2.4)
PARAM(scsee_v1, 203, 12.0)
PARAM(se_v2, 114, 12.0)
PARAM(se_v5, 27, 3.6)
PARAM(prb_v1, 121, 14.4)
PARAM(prb_v2, 48, 4.8)
PARAM(rfp_v1, 9, 0.6)
PARAM(lmr_v3, 3750, 300.0)
PARAM(lmr_v4, 94, 12.0)
PARAM(lmr_v5, 92, 12.0)
PARAM(lmr_v6, 82, 12.0)
PARAM(lmr_v7, 119, 12.0)
PARAM(hb_v1, 716, 60.0)
PARAM(hb_v2, 208, 18.0)
PARAM(hb_v3, 124, 24.0)
PARAM(hb_v4, 2451, 180.0)
PARAM(hm_v1, 592, 60.0)
PARAM(hm_v2, 196, 18.0)
PARAM(hm_v3, 136, 24.0)
PARAM(hm_v4, 1879, 180.0)
PARAM(asd_v1, 4, 0.6)
PARAM(qsf_v1, 198, 18.0)
PARAM(ch_v1, 25, 3.6)
PARAM(ch_v2, 194, 18.0)
PARAM(ch_v3, 267, 24.0)
PARAM(ch_v4, 70, 9.6)
PARAM(ch_v5, 106, 9.6)
PARAM(ch_v6, 100, 9.6)
PARAM(ch_v7, 97, 9.6)
...
PARAM(mat_scale, 25990, 420.0)
PARAM(mat_n, 651, 60.0)
PARAM(mat_b, 764, 78.0)
PARAM(mat_r, 1462, 120.0)
PARAM(mat_q, 2416, 240.0)
PARAM(pcmb_v1, 84, 12.0)
PARAM(pcmb_v3, 26, 4.8)
PARAM(pcmb_v4, 156, 12.0)
PARAM(pcmb_v5, 7, 0.6)
PARAM(pcmb_v6, 118, 12.0)
PARAM(pcmb_v7, 100, 12.0)
PARAM(pcmb_v8, 129, 8.4)
PARAM(pcmb_v9, 270, 30.0)
PARAM(pcmb_v10, 127, 8.4)
PARAM(pcmb_v11, 143, 8.4)
PARAM(r_v2, 2587, 250.0)
PARAM(r_v6, 1068, 150.0)
PARAM(r_v7, 1119, 150.0)
PARAM(r_v8, 2418, 250.0)
PARAM(r_v9, 1683, 250.0)
PARAM(r_v10, 926, 100.0)
PARAM(r_v11, 1052, 100.0)
PARAM(r_v12, 918, 100.0)
PARAM(r_v13, 994, 50.0)
PARAM(ded_v1, 61, 7.2)
PARAM(lce_v1, 2279, 18.0)
PARAM(qb_v1, 188, 18.0)
PARAM(qb_v2, 186, 18.0)
PARAM(cms_v1, 29029, 300.0)
PARAM(hu_v1, 10054, 300.0)
PARAM(cpth_v1, 11485, 300.0)
