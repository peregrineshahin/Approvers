...
PARAM(ttct_v2, 126, 12.0)
PARAM(qmo_v1, 434, 38.0)
PARAM(qmo_v2, 1299, 120.0)
PARAM(qmo_v3, 964, 120.0)
PARAM(rz_v1, 6, 0.5)
PARAM(rz_v2, 348, 16.0)
PARAM(rz_v3, 237, 10.0)
PARAM(ft_v1, 88, 12.0)
PARAM(ft_v2, 16, 0.5)
PARAM(nmp_v4, 184, 4.0)
PARAM(nmp_v5, 25293, 150.0)
PARAM(nmp_v6, 24, 3.0)
PARAM(nmp_v8, 91, 6.0)
PARAM(nmp_v9, 197, 12.0)
PARAM(rd_v1, 584, 60.0)
PARAM(rd_v2, 1243, 48.0)
PARAM(rd_v3, 931, 72.0)
PARAM(rd_init_v1, 3678, 150.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 3, 9.6)
PARAM(cbp_v3, -14, 9.6)
PARAM(cbp_v4, -7, 9.6)
PARAM(fpp_v1, 7, 0.5)
PARAM(fpp_v2, 224, 24.0)
PARAM(fpp_v3, 177, 21.6)
PARAM(fpp_v4, 67, 7.2)
PARAM(fpp_v5, 69, 7.2)
PARAM(sqsee_v1, 27, 2.4)
PARAM(scsee_v1, 202, 12.0)
PARAM(se_v2, 154, 15.0)
PARAM(se_v5, 28, 3.6)
PARAM(prb_v1, 127, 14.4)
PARAM(prb_v2, 47, 4.8)
PARAM(lmr_v3, 3667, 300.0)
PARAM(hb_v1, 912, 70.0)
PARAM(hb_v2, 197, 18.0)
PARAM(hb_v3, 150, 20.0)
PARAM(hb_v4, 2619, 180.0)
PARAM(hm_v1, 726, 70.0)
PARAM(hm_v2, 203, 18.0)
PARAM(hm_v3, 130, 20.0)
PARAM(hm_v4, 1613, 180.0)
PARAM(cnht_v1, 996, 80.0)
PARAM(cnht_v2, 1051, 80.0)
PARAM(cnht_v3, 1016, 80.0)
PARAM(cnht_v4, 963, 80.0)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 196, 18.0)
PARAM(ch_v1, 23, 3.6)
PARAM(ch_v2, 169, 18.0)
PARAM(ch_v3, 235, 24.0)
PARAM(ch_v5, 143, 12.0)
PARAM(ch_v6, 132, 12.0)
PARAM(ch_v7, 116, 12.0)
PARAM(ch_v8, 112, 12.0)
PARAM(ch_v9, 124, 12.0)
PARAM(ch_v10, 90, 12.0)
PARAM(tempo, 43, 4.8)
PARAM(mp_v1, 70, 3.0)
PARAM(mp_v2, 1054, 25.0)
PARAM(mp_v3, 2483, 180.0)
PARAM(mp_v4, 190, 12.0)
PARAM(mp_v5, 327, 12.0)
PARAM(mp_v6, 295, 12.0)
PARAM(mp_v7, 248, 12.0)
PARAM(mp_v8, 135, 12.0)
PARAM(eval_scale, 93, 2.0)
PARAM(mat_scale, 25851, 340.0)
PARAM(mat_n, 667, 48.0)
PARAM(mat_b, 729, 63.0)
PARAM(mat_r, 1498, 96.0)
PARAM(mat_q, 2364, 192.0)
PARAM(pcmb_v1, 82, 12.0)
PARAM(pcmb_v4, 151, 12.0)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 111, 12.0)
PARAM(pcmb_v7, 102, 12.0)
PARAM(pcmb_v8, 127, 8.4)
PARAM(pcmb_v9, 242, 30.0)
PARAM(pcmb_v10, 124, 8.4)
PARAM(pcmb_v11, 140, 8.4)
PARAM(r_v2, 2603, 250.0)
PARAM(r_v6, 1310, 150.0)
PARAM(r_v7, 1157, 150.0)
PARAM(r_v8, 2298, 150.0)
PARAM(r_v13, 977, 50.0)
PARAM(ded_v1, 62, 6.0)
PARAM(qb_v1, 185, 18.0)
PARAM(qb_v2, 182, 18.0)
