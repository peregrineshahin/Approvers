...
PARAM(rd_v1, 399, 60.0)
PARAM(rd_v2, 753, 48.0)
PARAM(rd_v3, 862, 72.0)
PARAM(rd_init_v1, 2896, 120.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 5, 9.6)
PARAM(cbp_v3, -6, 9.6)
PARAM(cbp_v4, -12, 9.6)
...
PARAM(r_v1, 2575, 400.0)
PARAM(r_v2, 1167, 200.0)
PARAM(r_v3, 935, 200.0)
PARAM(r_v4, 2287, 400.0)
PARAM(r_v5, 3694, 300.0)
PARAM(r_v6, 987, 50.0)
PARAM(ded_v1, 64, 7.2)
