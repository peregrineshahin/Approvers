...
// Search parameters
PARAM(ttct_v1, 100, 9.6)
PARAM(ttct_v2, 100, 9.6)
PARAM(qmo_v1, 367, 30.0)
PARAM(qmo_v2, 1230, 120.0)
PARAM(qmo_v3, 1010, 120.0)
PARAM(ft_v1, 197, 18.0)
PARAM(rd_v1, 595, 60.0)
PARAM(rd_v2, 1237, 48.0)
PARAM(rd_v3, 848, 72.0)
PARAM(rd_init_v1, 2881, 120.0)
PARAM(d_v1, 17, 1.2)
PARAM(cbp_v2, 0, 9.6)
PARAM(cbp_v3, 0, 9.6)
PARAM(cbp_v4, 0, 9.6)
PARAM(fpp_v1, 7, 0.6)
PARAM(fpp_v2, 214, 24.0)
PARAM(fpp_v3, 183, 21.6)
PARAM(fpp_v4, 64, 7.2)
PARAM(fpp_v5, 64, 7.2)
PARAM(sqsee_v1, 27, 2.4)
PARAM(scsee_v1, 199, 12.0)
PARAM(se_v2, 111, 12.0)
PARAM(se_v5, 27, 3.6)
PARAM(prb_v1, 125, 14.4)
PARAM(prb_v2, 43, 4.8)
PARAM(rfp_v1, 9, 0.6)
PARAM(lmr_v3, 3919, 300.0)
PARAM(lmr_v4, 102, 12.0)
PARAM(lmr_v5, 92, 12.0)
PARAM(lmr_v6, 93, 12.0)
PARAM(lmr_v7, 112, 12.0)
PARAM(hb_v1, 648, 60.0)
PARAM(hb_v2, 201, 18.0)
PARAM(hb_v3, 161, 24.0)
PARAM(hb_v4, 2491, 180.0)
PARAM(hm_v1, 589, 60.0)
PARAM(hm_v2, 190, 18.0)
PARAM(hm_v3, 153, 24.0)
PARAM(hm_v4, 1709, 180.0)
PARAM(asd_v1, 4, 0.6)
PARAM(qsf_v1, 185, 18.0)
PARAM(ch_v1, 22, 3.6)
PARAM(ch_v2, 162, 18.0)
PARAM(ch_v3, 286, 24.0)
PARAM(ch_v4, 84, 9.6)
PARAM(ch_v5, 105, 9.6)
PARAM(ch_v6, 100, 9.6)
PARAM(ch_v7, 100, 9.6)
PARAM(ch_v8, 100, 9.6)
PARAM(tempo, 44, 4.8)
PARAM(mp_v3, 2724, 180.0)
PARAM(mp_v4, 137, 9.6)
PARAM(mp_v5, 256, 9.6)
PARAM(mp_v6, 226, 9.6)
PARAM(mp_v7, 185, 9.6)
PARAM(mp_v8, 87, 9.6)
PARAM(eval_scale, 89, 3.0)
PARAM(mat_scale, 26273, 420.0)
PARAM(mat_n, 653, 60.0)
PARAM(mat_b, 812, 78.0)
PARAM(mat_r, 1379, 120.0)
PARAM(mat_q, 2547, 240.0)
PARAM(pcmb_v1, 100, 12.0)
PARAM(pcmb_v3, 29, 4.8)
PARAM(pcmb_v4, 163, 12.0)
PARAM(pcmb_v5, 7, 0.6)
PARAM(pcmb_v6, 114, 12.0)
PARAM(pcmb_v7, 101, 12.0)
PARAM(pcmb_v8, 126, 8.4)
PARAM(pcmb_v9, 238, 30.0)
PARAM(pcmb_v10, 122, 8.4)
PARAM(pcmb_v11, 144, 8.4)
PARAM(r_v2, 2183, 250.0)
PARAM(r_v6, 1290, 150.0)
PARAM(r_v7, 1089, 150.0)
PARAM(r_v8, 1975, 250.0)
PARAM(r_v9, 1727, 250.0)
PARAM(r_v10, 860, 100.0)
PARAM(r_v11, 996, 100.0)
PARAM(r_v12, 1109, 100.0)
PARAM(r_v13, 993, 50.0)
PARAM(ded_v1, 64, 7.2)
PARAM(lce_v1, 2280, 18.0)
PARAM(qb_v1, 198, 18.0)
PARAM(qb_v2, 195, 18.0)
PARAM(cms_v1, 29265, 300.0)
PARAM(hu_v1, 10081, 300.0)
PARAM(cpth_v1, 11833, 300.0)
