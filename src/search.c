...
// Search parameters
PARAM(ttct_v1, 135, 12.0)
PARAM(ttct_v2, 128, 12.0)
PARAM(qmo_v1, 437, 38.0)
PARAM(qmo_v2, 1282, 120.0)
PARAM(qmo_v3, 885, 120.0)
PARAM(rz_v1, 6, 0.5)
PARAM(rz_v2, 354, 16.0)
PARAM(rz_v3, 243, 10.0)
PARAM(ft_v1, 88, 12.0)
PARAM(ft_v2, 16, 0.5)
PARAM(nmp_v5, 25303, 150.0)
PARAM(nmp_v6, 27, 3.0)
PARAM(nmp_v8, 90, 6.0)
PARAM(nmp_v9, 204, 12.0)
PARAM(rd_v1, 575, 60.0)
PARAM(rd_v2, 1242, 48.0)
PARAM(rd_v3, 890, 72.0)
PARAM(rd_init_v1, 3697, 150.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 3, 9.6)
PARAM(cbp_v3, -9, 9.6)
PARAM(cbp_v4, -11, 9.6)
PARAM(fpp_v1, 7, 0.5)
PARAM(fpp_v2, 218, 24.0)
...
PARAM(prb_v2, 47, 4.8)
PARAM(lmr_v3, 3821, 300.0)
PARAM(lmr_v8, 14499, 150.0)
PARAM(hb_v1, 928, 75.0)
PARAM(hb_v2, 205, 18.0)
PARAM(hb_v3, 148, 24.0)
PARAM(hb_v4, 2492, 180.0)
PARAM(hm_v1, 704, 75.0)
PARAM(hm_v2, 204, 18.0)
PARAM(hm_v3, 122, 24.0)
PARAM(hm_v4, 1843, 180.0)
PARAM(cnht_v1, 1037, 80.0)
PARAM(cnht_v2, 1021, 80.0)
PARAM(cnht_v3, 998, 80.0)
PARAM(cnht_v4, 994, 80.0)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 187, 18.0)
PARAM(ch_v1, 22, 3.6)
PARAM(ch_v2, 178, 18.0)
PARAM(ch_v3, 242, 24.0)
PARAM(ch_v4, 93, 12.0)
PARAM(ch_v5, 139, 12.0)
PARAM(ch_v6, 130, 12.0)
PARAM(ch_v7, 117, 12.0)
PARAM(ch_v8, 126, 12.0)
PARAM(tempo, 44, 4.8)
PARAM(mp_v3, 2602, 180.0)
PARAM(mp_v4, 184, 12.0)
PARAM(mp_v5, 325, 12.0)
PARAM(mp_v6, 290, 12.0)
PARAM(mp_v7, 250, 12.0)
PARAM(mp_v8, 132, 12.0)
PARAM(eval_scale, 91, 3.0)
PARAM(mat_scale, 25811, 420.0)
PARAM(mat_n, 651, 60.0)
PARAM(mat_b, 749, 78.0)
PARAM(mat_r, 1475, 120.0)
PARAM(mat_q, 2526, 240.0)
PARAM(pcmb_v1, 82, 12.0)
PARAM(pcmb_v3, 23, 4.8)
PARAM(pcmb_v4, 155, 12.0)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 108, 12.0)
PARAM(pcmb_v7, 95, 12.0)
PARAM(pcmb_v8, 130, 8.4)
PARAM(pcmb_v9, 253, 30.0)
PARAM(pcmb_v10, 126, 8.4)
PARAM(pcmb_v11, 142, 8.4)
PARAM(r_v2, 2427, 250.0)
PARAM(r_v6, 1200, 150.0)
PARAM(r_v7, 1110, 150.0)
PARAM(r_v8, 1324, 150.0)
PARAM(r_v9, 949, 150.0)
PARAM(r_v13, 1009, 50.0)
PARAM(ded_v1, 64, 7.2)
PARAM(qb_v1, 184, 18.0)
PARAM(qb_v2, 185, 18.0)
PARAM(cms_v1, 29129, 300.0)
PARAM(hu_v1, 10294, 300.0)
PARAM(cpth_v1, 11690, 300.0)
