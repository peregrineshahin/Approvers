...
int16_t lmr_l1_weights[6][8] = {{-2109, 1775, 2103, 1837, 1720, -2053, 1696, 1776},
                                {1867, -2358, -1856, -2455, -2417, 1123, -2365, -2358},
                                {906, -1395, -923, -1374, -1348, 475, -1436, -1462},
                                {733, -1154, -801, -1238, -1242, 542, -1236, -1296},
                                {-26, 33, -10, 130, -102, -73, 32, 43},
                                {-75, 19, -118, -10, 71, -87, 29}};
int16_t lmr_l1_biases[8]     = {-295, -184, 300, -238, -197, -483, -236, -281};
int16_t lmr_l2_weights[8]    = {1558, -1255, -1553, -1360, -1244, 1338, -1212, -1322};
int16_t lmr_l2_biases[1]     = {931};
