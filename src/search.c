...
PARAM(nmp_v3, 165, 0)
PARAM(r_v1, 1056, 0)
PARAM(cms_v1, 29168, 0)
PARAM(hu_v1, 10354, 0)
PARAM(cpth_v1, 11611, 0)

// Search parameters
PARAM(ttct_v1, 146, 12.0)
PARAM(ttct_v2, 122, 12.0)
PARAM(qmo_v1, 433, 38.0)
PARAM(qmo_v2, 1321, 120.0)
PARAM(qmo_v3, 936, 120.0)
PARAM(rz_v1, 6, 0.5)
PARAM(rz_v2, 351, 16.0)
PARAM(rz_v3, 236, 10.0)
PARAM(ft_v1, 83, 12.0)
PARAM(ft_v2, 16, 0.5)
...
PARAM(cbp_v4, -10, 9.6)
PARAM(fpp_v1, 7, 0.5)
PARAM(fpp_v2, 243, 24.0)
PARAM(fpp_v3, 187, 21.6)
PARAM(fpp_v4, 66, 7.2)
PARAM(fpp_v5, 69, 7.2)
...
PARAM(prb_v2, 47, 4.8)
PARAM(lmr_v3, 3871, 300.0)
PARAM(hb_v1, 933, 70.0)
PARAM(hb_v2, 193, 18.0)
PARAM(hb_v3, 140, 20.0)
PARAM(hb_v4, 2543, 180.0)
PARAM(hm_v1, 723, 70.0)
PARAM(hm_v2, 217, 18.0)
PARAM(hm_v3, 125, 20.0)
PARAM(hm_v4, 1483, 180.0)
PARAM(cnht_v1, 998, 80.0)
PARAM(cnht_v2, 1010, 80.0)
PARAM(cnht_v3, 1008, 80.0)
PARAM(cnht_v4, 942, 80.0)
PARAM(asd_v1, 3, 0.5)
...
PARAM(ch_v8, 110, 12.0)
PARAM(ch_v9, 126, 12.0)
PARAM(ch_v10, 87, 12.0)
PARAM(tempo, 42, 4.8)
PARAM(mp_v1, 72, 3.0)
PARAM(mp_v2, 1065, 25.0)
PARAM(mp_v3, 2678, 180.0)
PARAM(mp_v4, 195, 12.0)
PARAM(mp_v5, 333, 12.0)
PARAM(mp_v6, 294, 12.0)
PARAM(mp_v7, 250, 12.0)
PARAM(mp_v8, 143, 12.0)
PARAM(eval_scale, 93, 2.0)
PARAM(mat_scale, 25855, 340.0)
PARAM(mat_n, 643, 48.0)
PARAM(mat_b, 750, 63.0)
PARAM(mat_r, 1461, 96.0)
...
PARAM(pcmb_v8, 131, 8.4)
PARAM(pcmb_v9, 225, 30.0)
PARAM(pcmb_v10, 127, 8.4)
PARAM(pcmb_v11, 135, 8.4)
PARAM(r_v2, 2482, 250.0)
PARAM(r_v6, 1334, 150.0)
PARAM(r_v7, 1092, 150.0)
PARAM(r_v8, 2166, 150.0)
PARAM(r_v13, 969, 50.0)
PARAM(ded_v1, 63, 6.0)
