...
PARAM(ttct_v2, 100, 8)
PARAM(qmo_v1, 415, 25)
PARAM(qmo_v2, 1290, 100)
PARAM(qmo_v3, 1057, 100)
PARAM(ft_v1, 188, 15)
PARAM(rd_v1, 632, 50)
PARAM(rd_v2, 1217, 40)
PARAM(rd_v3, 864, 60)
PARAM(rd_init_v1, 2866, 100)
PARAM(d_v1, 18, 1)
PARAM(cbp_v2, -3, 8)
PARAM(cbp_v3, 0, 8)
PARAM(cbp_v4, -8, 8)
...
PARAM(fpp_v5, 65, 6)
PARAM(sqsee_v1, 27, 2)
PARAM(scsee_v1, 198, 10)
PARAM(se_v2, 111, 10)
PARAM(se_v5, 26, 3)
PARAM(prb_v1, 124, 12)
PARAM(prb_v2, 43, 4)
PARAM(rfp_v1, 9, 0.5)
PARAM(lmr_v3, 3958, 250)
PARAM(lmr_v4, 102, 10)
PARAM(lmr_v5, 84, 10)
PARAM(lmr_v6, 97, 10)
PARAM(lmr_v7, 111, 10)
...
PARAM(hb_v2, 212, 15)
PARAM(hb_v3, 161, 20)
PARAM(hb_v4, 2542, 150)
PARAM(hm_v1, 585, 50)
PARAM(hm_v2, 200, 15)
PARAM(hm_v3, 148, 20)
PARAM(hm_v4, 1596, 150)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 183, 15)
PARAM(ch_v1, 20, 3)
PARAM(ch_v2, 167, 15)
...
PARAM(mat_scale, 26124, 350)
PARAM(mat_n, 674, 50)
PARAM(mat_b, 833, 65)
PARAM(mat_r, 1381, 100)
PARAM(mat_q, 2514, 200)
PARAM(pcmb_v1, 99, 10)
PARAM(pcmb_v3, 30, 4)
PARAM(pcmb_v4, 160, 10)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 117, 10)
PARAM(pcmb_v7, 97, 10)
PARAM(pcmb_v8, 126, 7)
PARAM(pcmb_v9, 229, 25)
...
PARAM(r_v10, 761, 100)
PARAM(r_v11, 963, 100)
PARAM(r_v12, 1020, 100)
PARAM(r_v13, 1005, 50)
PARAM(ded_v1, 65, 6)
PARAM(lce_v1, 2268, 15)
PARAM(qb_v1, 199, 15)
PARAM(qb_v2, 189, 15)
PARAM(cms_v1, 29229, 250)
PARAM(hu_v1, 10158, 250)
PARAM(cpth_v1, 11771, 250)
