...
const int nmp_v1     = 773;
const int nmp_v2     = 72;
const int nmp_v3     = 193;
const int nmp_v4     = 206;
const int nmp_v5     = 23275;
const int nmp_v6     = 29;
const int nmp_v7     = 26;
const int nmp_v8     = 88;
const int nmp_v9     = 164;
const int lph_v1     = 1149;
const int lph_v2     = 562;
const int qmo_v1     = 380;
const int qmo_v2     = 1081;
const int qmo_v3     = 1040;
const int rz_v1      = 517;
const int ft_v1      = 217;
const int rd_v1      = 538;
const int rd_v2      = 1151;
const int rd_v3      = 888;
const int sb_v1      = 13;
const int sb_v2      = 30;
const int sb_v3      = 17;
const int sb_v4      = 136;
const int rd_init_v1 = 2319;
const int d_v1       = 21;
const int iir_v1     = 614;
const int iir_v2     = 202;
const int cbp_v1     = 428;
const int cbp_v2     = 6;
const int fpp_v1     = 690;
const int fpp_v2     = 298;
const int fpp_v3     = 168;
const int fpp_v4     = 27912;
const int sqsee_v1   = 2937;
const int sqsee_v2   = 1790;
const int sch_v1     = 99;
const int sch_v2     = -1;
const int sfpc_v1    = 617;
const int sfpc_v2    = 179;
const int sfpc_v3    = 159;
const int sfpc_v4    = 238;
const int scsee_v1   = 219;
const int se_v1      = 654;
const int se_v2      = 372;
const int se_v3      = 229;
const int se_v4      = 283;
const int se_v5      = 7696;
const int se_v6      = 101;
const int prb_v1     = 173;
const int prb_v2     = 51;
const int rfp_v1     = 840;
const int lmr_v1     = 1019;
const int lmr_v2     = 1287;
const int lmr_v3     = 4593;
const int lmr_v4     = 98;
const int lmr_v5     = 98;
const int lmr_v6     = 127;
const int lmr_v7     = 138;
const int lmr_v8     = 15862;
const int fmc_v1     = 293;
const int fmc_v2     = 285;
const int fmc_v3     = 203;
const int asd_v1     = 464;
const int ses_v1     = 323;
const int qsf_v1     = 151;
const int ch_v1      = 1760;
const int ch_v2      = 261;
const int ch_v3      = 292;
const int tempo      = 59;
const int mp_v1      = 67;
const int mp_v2      = 1099;
const int mp_v3      = 3041;
const int mp_v4      = 110;
const int mp_v5      = 209;
const int mp_v6      = 204;
const int mp_v7      = 195;
const int mp_v8      = 107;
const int mp_v9      = 98;
const int mp_v10     = 377;
const int mp_v11     = 251;
const int eval_scale = 95;
