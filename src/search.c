...
PARAM(ttct_v2, 102, 8)
PARAM(qmo_v1, 416, 25)
PARAM(qmo_v2, 1277, 100)
PARAM(qmo_v3, 1023, 100)
PARAM(ft_v1, 181, 15)
PARAM(rd_v1, 640, 50)
PARAM(rd_v2, 1221, 40)
PARAM(rd_v3, 869, 60)
PARAM(rd_init_v1, 2853, 100)
PARAM(d_v1, 18, 1)
PARAM(cbp_v2, -5, 8)
PARAM(cbp_v3, 2, 8)
PARAM(cbp_v4, -9, 8)
...
PARAM(fpp_v5, 66, 6)
PARAM(sqsee_v1, 27, 2)
PARAM(scsee_v1, 197, 10)
PARAM(se_v2, 112, 10)
PARAM(se_v5, 26, 3)
PARAM(prb_v1, 124, 12)
PARAM(prb_v2, 44, 4)
PARAM(rfp_v1, 9, 0.5)
PARAM(lmr_v3, 4003, 250)
PARAM(lmr_v4, 103, 10)
PARAM(lmr_v5, 83, 10)
PARAM(lmr_v6, 97, 10)
PARAM(lmr_v7, 111, 10)
...
PARAM(hb_v2, 211, 15)
PARAM(hb_v3, 153, 20)
PARAM(hb_v4, 2514, 150)
PARAM(hm_v1, 581, 50)
PARAM(hm_v2, 194, 15)
PARAM(hm_v3, 149, 20)
PARAM(hm_v4, 1602, 150)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 187, 15)
PARAM(ch_v1, 20, 3)
PARAM(ch_v2, 169, 15)
...
PARAM(ch_v8, 106, 8)
PARAM(tempo, 44, 4)
PARAM(mp_v3, 2788, 150)
PARAM(mp_v4, 149, 8)
PARAM(mp_v5, 253, 8)
PARAM(mp_v6, 223, 8)
PARAM(mp_v7, 186, 8)
PARAM(mp_v8, 87, 8)
PARAM(eval_scale, 93, 5)
PARAM(mat_scale, 26120, 350)
PARAM(mat_n, 686, 50)
PARAM(mat_b, 839, 65)
PARAM(mat_r, 1383, 100)
PARAM(mat_q, 2469, 200)
PARAM(pcmb_v1, 100, 10)
PARAM(pcmb_v3, 29, 4)
PARAM(pcmb_v4, 159, 10)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 119, 10)
PARAM(pcmb_v7, 98, 10)
PARAM(pcmb_v8, 126, 7)
PARAM(pcmb_v9, 231, 25)
PARAM(pcmb_v10, 117, 7)
PARAM(pcmb_v11, 145, 7)
PARAM(r_v1, 1055, 50)
PARAM(r_v2, 2335, 250)
PARAM(r_v6, 1248, 250)
PARAM(r_v7, 1166, 250)
...
PARAM(r_v10, 785, 100)
PARAM(r_v11, 897, 100)
PARAM(r_v12, 1011, 100)
PARAM(r_v13, 1005, 50)
PARAM(ded_v1, 64, 6)
PARAM(lce_v1, 2273, 15)
PARAM(qb_v1, 201, 15)
PARAM(qb_v2, 188, 15)
PARAM(cms_v1, 29127, 250)
PARAM(hu_v1, 10186, 250)
PARAM(cpth_v1, 11772, 250)
