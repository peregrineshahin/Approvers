...
// Search parameters
PARAM(ttct_v1, 143, 12.0)
PARAM(ttct_v2, 131, 12.0)
PARAM(qmo_v1, 424, 38.0)
PARAM(qmo_v2, 1262, 120.0)
PARAM(qmo_v3, 977, 120.0)
PARAM(rz_v1, 6, 0.5)
PARAM(rz_v2, 349, 16.0)
PARAM(rz_v3, 239, 10.0)
PARAM(ft_v1, 86, 12.0)
PARAM(ft_v2, 16, 0.5)
PARAM(nmp_v5, 25298, 150.0)
PARAM(nmp_v6, 28, 3.0)
PARAM(nmp_v8, 90, 6.0)
PARAM(nmp_v9, 200, 12.0)
PARAM(rd_v1, 565, 60.0)
PARAM(rd_v2, 1262, 48.0)
PARAM(rd_v3, 941, 72.0)
PARAM(rd_init_v1, 3623, 150.0)
PARAM(d_v1, 18, 1.2)
PARAM(cbp_v2, 2, 9.6)
PARAM(cbp_v3, -10, 9.6)
PARAM(cbp_v4, -4, 9.6)
PARAM(fpp_v1, 7, 0.5)
PARAM(fpp_v2, 213, 24.0)
PARAM(fpp_v3, 171, 21.6)
PARAM(fpp_v4, 67, 7.2)
PARAM(fpp_v5, 72, 7.2)
PARAM(sqsee_v1, 27, 2.4)
PARAM(scsee_v1, 201, 12.0)
PARAM(se_v2, 152, 15.0)
PARAM(se_v5, 25, 3.6)
PARAM(prb_v1, 120, 14.4)
PARAM(prb_v2, 47, 4.8)
PARAM(lmr_v3, 3722, 300.0)
PARAM(lmr_v8, 14454, 150.0)
PARAM(hb_v1, 915, 75.0)
PARAM(hb_v2, 202, 18.0)
PARAM(hb_v3, 160, 24.0)
PARAM(hb_v4, 2482, 180.0)
PARAM(hm_v1, 700, 75.0)
PARAM(hm_v2, 208, 18.0)
PARAM(hm_v3, 118, 24.0)
PARAM(hm_v4, 1769, 180.0)
PARAM(cnht_v1, 1010, 80.0)
PARAM(cnht_v2, 1023, 80.0)
PARAM(cnht_v3, 973, 80.0)
PARAM(cnht_v4, 963, 80.0)
PARAM(asd_v1, 4, 0.5)
PARAM(qsf_v1, 190, 18.0)
PARAM(ch_v1, 25, 3.6)
PARAM(ch_v2, 171, 18.0)
PARAM(ch_v3, 240, 24.0)
PARAM(ch_v4, 91, 12.0)
PARAM(ch_v5, 138, 12.0)
PARAM(ch_v6, 130, 12.0)
PARAM(ch_v7, 124, 12.0)
PARAM(ch_v8, 127, 12.0)
PARAM(tempo, 49, 4.8)
PARAM(mp_v3, 2535, 180.0)
PARAM(mp_v4, 191, 12.0)
PARAM(mp_v5, 322, 12.0)
PARAM(mp_v6, 289, 12.0)
PARAM(mp_v7, 256, 12.0)
PARAM(mp_v8, 131, 12.0)
PARAM(eval_scale, 92, 3.0)
PARAM(mat_scale, 26083, 420.0)
PARAM(mat_n, 675, 60.0)
PARAM(mat_b, 762, 78.0)
PARAM(mat_r, 1491, 120.0)
PARAM(mat_q, 2685, 240.0)
PARAM(pcmb_v1, 82, 12.0)
PARAM(pcmb_v3, 23, 4.8)
PARAM(pcmb_v4, 152, 12.0)
PARAM(pcmb_v5, 7, 0.5)
PARAM(pcmb_v6, 118, 12.0)
PARAM(pcmb_v7, 102, 12.0)
PARAM(pcmb_v8, 129, 8.4)
PARAM(pcmb_v9, 251, 30.0)
PARAM(pcmb_v10, 126, 8.4)
PARAM(pcmb_v11, 141, 8.4)
PARAM(r_v2, 2551, 250.0)
PARAM(r_v6, 1244, 150.0)
PARAM(r_v7, 1046, 150.0)
PARAM(r_v8, 1368, 150.0)
PARAM(r_v9, 942, 150.0)
PARAM(r_v13, 1036, 50.0)
PARAM(ded_v1, 60, 7.2)
PARAM(qb_v1, 180, 18.0)
PARAM(qb_v2, 191, 18.0)
PARAM(cms_v1, 29090, 300.0)
PARAM(hu_v1, 10264, 300.0)
PARAM(cpth_v1, 11580, 300.0)
