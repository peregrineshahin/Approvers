...
static Bitboard attacks_bb_queen(Square s, Bitboard occupied) {
    ...
    slide4 = _mm256_ternarylogic_epi64(slide4, _mm256_add_epi64(slide4, _mm256_set1_epi64x(-1)),
                                       lmask, 0x28);
...
static Bitboard attacks_bb_rook(Square s, Bitboard occupied) {
    ...
    slide2 =
      _mm_ternarylogic_epi64(slide2, _mm_add_epi64(slide2, _mm_set1_epi64x(-1)), lmask, 0x28);
    // Right bits: set mask bits higher than occupied MS1B
